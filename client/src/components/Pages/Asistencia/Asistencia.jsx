...
const Asistencia = () => {
  ...
  return (
    <div>
      ...
      <div
        className="relative flex flex-col justify-center items-center w-full h-[60vh] md:h-[70vh] bg-cover bg-center"
        style={{
      ...
      <div className="flex flex-col items-center py-6 md:py-10 bg-white shadow-md rounded-lg mt-4 mx-4 md:mx-8 lg:mx-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full px-4">
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gradient-to-r from-green-400 to-blue-500 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex justify-center items-center h-28 md:h-32 bg-gray-200">
              <Flag country="BR" size={96} className="text-4xl text-green-500" />
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gradient-to-r from-green-400 to-blue-500 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex justify-center items-center h-28 md:h-32 bg-gray-200">
              <Flag country="US" size={96} className="text-4xl text-green-500" />
            </div>
            <div className="p-4 text-center">
              <h3 className="text-lg md:text-xl font-bold underline">
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gradient-to-r from-green-400 to-blue-500 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex justify-center items-center h-28 md:h-32 bg-gray-200">
              <Flag country="EU" size={96} className="text-4xl text-green-500" />
            </div>
            <div className="p-4 text-center">
              <h3 className="text-lg md:text-xl font-bold underline">
        ...
        <p className="text-sm md:text-lg lg:text-2xl text-gray mx-6 mt-2">
        ...
        <button
          className="bg-[#0aeb08] text-white text-sm sm:text-base md:text-lg lg:text-xl px-4 mt-4 md:px-6 py-2 rounded-lg w-full md:w-auto"
          onClick={scrollToForm}
        >
          ¡SOLICITA TU COTIZACION AHORA!
        </button>
      ...
      >
        ...
        <h3 className="text-red-500 text-xl md:text-2xl font-bold mb-2 text-center">
          IMPORTANTE: Si buscas un seguro de bajo costo y con prestaciones limitadas, esta cotización no será adecuada para ti.
        </h3>
        <h3 className="text-gray-500 text-lg md:text-2xl font-bold mb-2 text-center">
          Trabajo con compañías líderes en asistencia de viaje, como Coris, Pax, Assist Card, Europ Assistance, Universal Assistance, y Terrawind Global Protection, que ofrecen cobertura integral y de alta calidad.
        </h3>
      ...
      <div className="flex flex-col md:flex-row items-center p-4 bg-white shadow-md rounded-lg mt-4 mx-4 md:mx-8 lg:mx-16">
        <div className="flex-shrink-0 mb-4 md:mb-0">
          <img
            ...
            className="w-24 h-24 md:w-42 md:h-42 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-[#0aeb08]"
          />
        </div>
        ...
        <div className="md:ml-4">
          ...
          <p className="text-gray text-sm md:text-lg lg:text-2xl mt-2">
            Hola, soy María Laura Lobrundo, Productora Asesora de Seguros (Mat. 81581), especializada en seguros de viaje y asistencia al viajero.
          </p>
          <p className="text-gray text-sm md:text-lg lg:text-2xl mt-2">
            Aunque en muchos casos los seguros de viaje no son obligatorios para ingresar a determinados países, son absolutamente necesarios.
          </p>
        </div>
      </div>
    </div>
