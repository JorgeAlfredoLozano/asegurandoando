...
const Asistencia = () => {
  const formRef = useRef(null); // Creamos la referencia al formulario
    ...
    <div>
      ...
      >
        ...
        <div className="absolute top-20 flex flex-col items-center text-center px-4 space-y-4">
          ...
          <h3 className="text-gray-300 text-3xl md:text-3xl lg:text-3xl font-bold">
          ...
          {/* Botón modificado con acción de scroll */}
          <button
