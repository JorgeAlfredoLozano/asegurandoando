...
function Footer() {
  ...
  //         <p className="text-2xl">Asegurando</p>
  //         <p className="m-1 text-blue-500 text-2xll">Ando</p>
  //       </div>
  ...
  //         </div>
  //         <div className="flex flex-col items-start justify-center m-2 px-7">
  //           <h3 className="mb-2 font-poppins font-bold">Sobre Nosotros</h3>
  ...
  //           AsegurandoAndo© 2023. Todos los derechos reservados
  //         </p>
  //       </div>
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            ...
            <a class="hover:opacity-75" href> Ubicación </a>
        ...
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a class="hover:opacity-75" href> Seguros Generales </a>
            <a class="hover:opacity-75" href> Seguros de Viajes </a>
            <a class="hover:opacity-75" href> Asesoría de flotas </a>
            <a class="hover:opacity-75" href> Gestoría </a>
            <a class="hover:opacity-75" href> Trámites </a>
          </nav>
        </div>
        <div>
          <p class="font-medium text-white">
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a class="hover:opacity-75" href> Sancor Seguros </a>
            <a class="hover:opacity-75" href> Copán Seguros </a>
            <a class="hover:opacity-75" href> La Perseverancia </a>
            <a class="hover:opacity-75" href> Triunfo Seguros </a>
            <a class="hover:opacity-75" href> Galeno Seguros </a>
            <a class="hover:opacity-75" href> Nación Seguros </a>
          </nav>
        </div>
        <div>
          <p class="font-medium text-white">
